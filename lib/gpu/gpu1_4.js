...
var W = document.getElementById("c4").width;
var H = document.getElementById("c4").height;
...
/* draw grid */
ctx4.fillStyle="rgba(0,0,0,0.12)";
for(var i=0; i<W; i+=8){
	ctx4.fillRect(i, 0, 4, H);
}
for(var i=0; i<H; i+=8){
	ctx4.fillRect(0, i, W, 4);
}
...
function wnorm(v){
	return [v[0]/v[3], v[1]/v[3], v[2]/v[3], 1/v[3]];
}
